...
<section>
    <div class="signin-message">
        ...
        <div id = "errorDanger" class="text-center">
            <?php 
                session_start();
                if(isset( $_SESSION['userMessageForgetPassword'])){
                    echo $_SESSION['userMessageForgetPassword'];
                }             
            ?>
        </div>
        <div class="text-center signinFields">
            <form action="http://localhost/loginpage/controllers/fp_emailcheckController.php" method="post">
                <div class="form-group">
                    <label for="userEmail">Email address</label>
                    <input type="email" class="form-control" id="userEmailForgetPassword"
                        name="userEmailForgetPassword" aria-describedby="emailHelp" placeholder="Enter email" required>
                </div>
